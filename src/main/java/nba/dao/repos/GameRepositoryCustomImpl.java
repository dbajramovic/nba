...
public class GameRepositoryCustomImpl implements GameRepositoryCustom {
    ...
    public List<GameLight> getAll(String year) {
        String query = "select new nba.model.GameLight(game.gameId, game.gameUrl, game.city, game.arena, game.date, game.id) from GameEntity game, BoxscoreEntity box where box.gameId = game.gameId and box.year = :year";
